...
**Last update:** 2026-04-26 — **KDE runtime** row + [kde-wsl2-runtime-verification.md](docs/kde-wsl2-runtime-verification.md) (probe: WSL default **root**, no `loginctl` sessions, Plasma **not** running in non-GUI `wsl -e`); prior 2026-04-25 full capture and manifest still apply to Windows 11 + `imports/`.
