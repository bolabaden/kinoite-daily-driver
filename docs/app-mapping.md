...
**This host (full capture 2026-04-25, `T175108` index = current):** `winget-export-20260425T175108.json`, `windows-inventory-20260425T175121.txt`, `winget-list-20260425T175108.txt` (**318** lines), `start-menu-shortcuts-20260425T175108.txt` (**838** lines), `wsl-Kinoite-WS2-verify-20260425T175108.txt` — all under `imports/`. Rerun the full-capture script after **bulk** app changes.  
