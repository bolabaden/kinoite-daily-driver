...
**Latest local export (this refresh):** `imports/winget-export-20260425T171450.json` (run `export-winget.ps1` to supersede)  
**Latest full inventory (CIM / WSL / podman):** `imports/windows-inventory-20260425T171455.txt` (run `run-windows-inventory.ps1` to supersede)  
