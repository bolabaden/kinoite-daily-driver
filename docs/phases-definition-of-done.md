...
- **KotOR.js (sibling checkout) and this tree:** the Kinoite workspace plan file lives in KotOR; how it maps to this repo and optional **`AGENTS.md`** pointers are in [kinoite-wsl2.md](kinoite-wsl2.md) (**## Spec and the KotOR.js repository**), [plan-stipulated-file-tree.md](plan-stipulated-file-tree.md), [provisional-configuration-index.md](provisional-configuration-index.md#kotor-plan-and-workspace-coverage-matrix) (Phase **A** rows), and [WORKSPACE_STATUS.md](../WORKSPACE_STATUS.md).
