# Kinoite + WSL2 — community pointers (non-authoritative)
...
**Note (2026-04-25):** importing the **container** rootfs into WSL produced a system where **`rpm-ostree` CLI refused** (`not booted via libostree`). Treat community “WSL + ostree” posts with skepticism; verify on your build.
